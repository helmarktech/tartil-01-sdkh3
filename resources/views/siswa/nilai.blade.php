...
<div class="sr-wrap">
    ...
    <div class="siswa-page-header">
        <div class="siswa-page-icon" style="background: linear-gradient(135deg, #1565c0, #1e3a8a);">
        ...
        <div>
            <h1 class="siswa-page-title">Rapor Saya</h1>
            <p class="siswa-page-subtitle">Unduh rapor hasil belajar per semester yang telah ditutup</p>
        </div>
    </div>
