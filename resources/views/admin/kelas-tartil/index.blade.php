...
@section('title', 'List Kelas Tartil')

@section('content')
<div>
    <div class="page-header" style="display: flex; justify-content: space-between; align-items: flex-start; flex-wrap: wrap; gap: 12px;">
        <div>
            <h1 class="page-title-display">List Kelas Tartil</h1>
            <p class="page-subtitle">Semua kelas tartil yang dibuat oleh admin beserta detailnya</p>
        </div>
