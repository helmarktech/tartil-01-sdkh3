        ...
        @else
            ...
            <div class="siswa-row">
                ...
                <div>
                    ...
                    <a href="{{ route('tahfidz.detail-siswa', $s['siswa']['id']) }}" class="btn-tartil-outline" style="padding: 6px 14px; font-size: 12px; text-decoration: none; margin-left: 4px;">Detail</a>
                </div>
            </div>
            @endforeach
        @endif
