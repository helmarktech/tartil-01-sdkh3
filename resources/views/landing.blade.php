...
<head>
    ...
    <style>
        *, *::before, *::after { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .footer-dev:hover { color: var(--accent-dark); }
        .footer-dev strong { color: var(--ink); font-weight: 600; }
        .footer-dev:hover strong { color: var(--accent-dark); }
        .footer-dev svg { width: 14px; height: 14px; color: #25d366; }
...
<body>
    ...
    <footer class="footer">
        ...
        <div class="footer-bottom">
            ...
            <a href="https://wa.me/6281217155985" target="_blank" rel="noopener" class="footer-dev">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 11.5a8.38 8.38 0 0 1-.9 3.8 8.5 8.5 0 0 1-7.6 4.7 8.38 8.38 0 0 1-3.8-.9L3 21l1.9-5.7a8.38 8.38 0 0 1-.9-3.8 8.5 8.5 0 0 1 4.7-7.6 8.38 8.38 0 0 1 3.8-.9h.5a8.48 8.48 0 0 1 8 8v.5z"/></svg>
                Designed &amp; Developed by <strong>PT. Helmark Tech Digital</strong>
            </a>
        </div>
    </footer>
