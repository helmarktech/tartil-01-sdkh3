...
return new class extends Migration
{
    ...
    {
        // Helper: cek apakah index sudah ada (hanya MySQL/MariaDB yang support SHOW INDEX)
    ...
    public function down(): void
    {
        ...
        if (Schema::hasTable('jurnal_harians')) {
            try {
                Schema::table('jurnal_harians', fn (Blueprint $t) => $t->dropIndex('idx_jurnal_kelas_sem_tgl'));
            } catch (Throwable $e) {
            }
            try {
                Schema::table('jurnal_harians', fn (Blueprint $t) => $t->dropIndex('idx_jurnal_siswa_sem'));
            } catch (Throwable $e) {
            }
            try {
                Schema::table('jurnal_harians', fn (Blueprint $t) => $t->dropIndex('idx_jurnal_sem_kelas'));
            } catch (Throwable $e) {
            }
        }
        ...
        if (Schema::hasTable('rekap_jurnal_bulanans')) {
            try {
                Schema::table('rekap_jurnal_bulanans', fn (Blueprint $t) => $t->dropIndex('idx_rekap_sem_kelas_siswa'));
            } catch (Throwable $e) {
            }
            try {
                Schema::table('rekap_jurnal_bulanans', fn (Blueprint $t) => $t->dropIndex('idx_rekap_siswa_sem'));
            } catch (Throwable $e) {
            }
        }
        ...
        if (Schema::hasTable('munaqosyah_pendaftarans')) {
            ...
            foreach ($fks as $fk) {
                try {
                    DB::statement("ALTER TABLE munaqosyah_pendaftarans DROP FOREIGN KEY {$fk->CONSTRAINT_NAME}");
                } catch (Throwable $e) {
                }
            }
            try {
                Schema::table('munaqosyah_pendaftarans', fn (Blueprint $t) => $t->dropIndex('idx_munaqosyah_status'));
            } catch (Throwable $e) {
            }
            try {
                Schema::table('munaqosyah_pendaftarans', fn (Blueprint $t) => $t->dropIndex('idx_munaqosyah_siswa'));
            } catch (Throwable $e) {
            }
        }
        ...
        if (Schema::hasTable('penilaian_rapor_nilais')) {
            try {
                Schema::table('penilaian_rapor_nilais', fn (Blueprint $t) => $t->dropIndex('idx_nilai_penilaian_siswa'));
            } catch (Throwable $e) {
            }
        }
        ...
        if (Schema::hasTable('semester_siswa')) {
            try {
                Schema::table('semester_siswa', fn (Blueprint $t) => $t->dropIndex('idx_ss_sem_kelas'));
            } catch (Throwable $e) {
            }
        }
    }
